...
import com.example.spring_ioc_test01.entity.*;
import com.example.spring_ioc_test01.mapper.OrderMapper;
import com.example.spring_ioc_test01.service.*;
...
//        查询地址数据
        ...
        long orderId = IdWorker.getId(); //生产订单号
//        向订单表插入数据，一条数据
